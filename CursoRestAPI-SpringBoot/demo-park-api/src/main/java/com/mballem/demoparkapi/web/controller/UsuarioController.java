...
public class UsuarioController {
    ...
    @Operation(summary =  "Recuperar dados de todos os usuários", description = "Recuperar dados de todos os usuários",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Recuperação de dados realizada com sucesso.",
